...
Job exports and scrape-report.json are under `runs/<timestamp>/cc-nurseries/`. Review the report even if no jobs are exported. Exit code 2 signals partial, failed or unsupported extraction; unexpected errors also return a nonzero code.
...
Configuration source: `output/combined 17-9-26 batches/code/cc-nurseries/company.json`.

Original URL returns 404. Official ccnurseries.com redirects to wildflowerchildcare.co.uk, which links to the same Jobtrain tenant at /ccnurseries. Current board branded Wildflower Childcare; verified 2026-09-17.
