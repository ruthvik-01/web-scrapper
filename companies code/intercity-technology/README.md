...
Job exports and scrape-report.json are under `runs/<timestamp>/intercity-technology/`. Review the report even if no jobs are exported. Exit code 2 signals partial, failed or unsupported extraction; unexpected errors also return a nonzero code.
...
Configuration source: `output/batch-2026-09-16/code/intercity-technology/company.json`.

Old domain does not resolve. New careers domain linked from https://www.intercity.technology/ on 2026-09-16.
