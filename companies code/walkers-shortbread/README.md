...
Job exports and scrape-report.json are under `runs/<timestamp>/`. Review the report even if no jobs are exported. Exit code 2 signals partial, failed or unsupported extraction; unexpected errors also return a nonzero code.
...
Configuration source: `output/batch 15-9-2026/code/walkers-shortbread/scrape.ts`.
