...
test("source SQL-format publication timestamps retain their calendar day without inventing timezone", () => {
  assert.equal(parsePostedDate("2026-08-02 06:15:05"), "2026-08-02");
